...
} else if (count($student->profileErrors) == 0 && $project->status == Project::STATUS_PUBLIC) {
    $this->menu = array(
...
<form class="form-horizontal">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <p class="help-block <?= $project->deadlinePassed ? 'error' : ''?>"><?= CHtml::encode($project->deadline) ?></p>
        </div>
    </div>
